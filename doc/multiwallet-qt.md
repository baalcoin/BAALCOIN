...
In order to support loading of multiple wallets in baalcoin-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is baalcoin.cpp.
...
Changes to baalcoin.cpp
----------------------
baalcoin.cpp is the entry point into baalcoin-qt, and as such, will require some minor modifications to provide hooks for
