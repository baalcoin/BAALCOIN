...
Intro
-----
BAALCOIN (BAAL) is a sustainable cryptocurrency modeled after 
...
high-powered mining hardware. BAALCOIN utilizes an energy efficient proof-of-stake algorithm, 
...
Setup
-----
Unpack the files into a directory and run baalcoin-qt.exe.

BAALCOIN Core is the original BAALCOIN client and it builds the backbone of the network.
However, it downloads and stores the entire history of BAALCOIN transactions;
