...
#   c) node1 mines 32 blocks, so now node 0 has 500000BAAL, node 1 has 4250BAAL, node2 has none.
#   d) node0 sends 601 BAAL to node2, in two transactions (301 BAAL, then 300 BAAL).
