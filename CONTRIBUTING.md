Contributing to BAALCOIN Core
==================================

The BAALCOIN Core project operates an open contributor model where anyone is
...
The following applies to code changes to the BAALCOIN Core project, and is not to be
confused with overall BAALCOIN Network Protocol consensus changes.

Whether a pull request is merged into BAALCOIN Core rests with the project merge
...
Patches that change BAALCOIN consensus rules are considerably more involved than
...
Where a patch set proposes to change the BAALCOIN consensus, it must have been
...
The project leader is the release manager for each BAALCOIN Core release.
