...
RESOURCES += src/qt/baalcoin.qrc src/qt/baalcoin_locale.qrc

TRANSLATIONS += src/qt/locale/baalcoin_bg.ts \
                src/qt/locale/baalcoin_de.ts \
                src/qt/locale/baalcoin_en.ts \
                src/qt/locale/baalcoin_es.ts \
                src/qt/locale/baalcoin_fi.ts \
                src/qt/locale/baalcoin_fr.ts \
                src/qt/locale/baalcoin_it.ts \
                src/qt/locale/baalcoin_ja.ts \
                src/qt/locale/baalcoin_pl.ts \
                src/qt/locale/baalcoin_pt.ts \
                src/qt/locale/baalcoin_ru.ts \
                src/qt/locale/baalcoin_sk.ts \
                src/qt/locale/baalcoin_sv.ts \
                src/qt/locale/baalcoin_vi.ts \
                src/qt/locale/baalcoin_zh_CN.ts \
                src/qt/locale/baalcoin_zh_TW.ts
