...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop BAALCOIN server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "BAALCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* BAALCOIN features */
        {"BAALCOIN", "masternode", &masternode, true, true, false},
        {"BAALCOIN", "listmasternodes", &listmasternodes, true, true, false},
        {"BAALCOIN", "getmasternodecount", &getmasternodecount, true, true, false},
        {"BAALCOIN", "masternodeconnect", &masternodeconnect, true, true, false},
        {"BAALCOIN", "masternodecurrent", &masternodecurrent, true, true, false},
        {"BAALCOIN", "masternodedebug", &masternodedebug, true, true, false},
        {"BAALCOIN", "startmasternode", &startmasternode, true, true, false},
        {"BAALCOIN", "createmasternodekey", &createmasternodekey, true, true, false},
        {"BAALCOIN", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"BAALCOIN", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"BAALCOIN", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"BAALCOIN", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"BAALCOIN", "getmasternodescores", &getmasternodescores, true, true, false},
        {"BAALCOIN", "mnbudget", &mnbudget, true, true, false},
        {"BAALCOIN", "preparebudget", &preparebudget, true, true, false},
        {"BAALCOIN", "submitbudget", &submitbudget, true, true, false},
        {"BAALCOIN", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"BAALCOIN", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"BAALCOIN", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"BAALCOIN", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"BAALCOIN", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"BAALCOIN", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"BAALCOIN", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"BAALCOIN", "checkbudgets", &checkbudgets, true, true, false},
        {"BAALCOIN", "mnsync", &mnsync, true, true, false},
        {"BAALCOIN", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
...
{
    return "> BAALCOIN-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:60034/\n";
}
