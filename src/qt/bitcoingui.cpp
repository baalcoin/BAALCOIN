                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("BAALCOIN Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a BAAL address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and baalcoin: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About BAALCOIN Core"), this);
    aboutAction->setStatusTip(tr("Show information about BAALCOIN Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for BAALCOIN"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your BAAL addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified BAAL addresses"));
    ...
    openAction->setStatusTip(tr("Open a baalcoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the BAALCOIN Core help message to get a list with possible BAALCOIN command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("BAALCOIN Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to BAALCOIN network", "", count));
}
...
{
    QString strTitle = tr("BAALCOIN Core"); // default title
