...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("BAALCOIN Core"),
     ...
     * override -datadir in the baalcoin.conf file in the default data directory
     * (to be consistent with baalcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
