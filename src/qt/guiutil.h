...
/** Utility functions used by the BAALcoin Qt UI.
 */
namespace GUIUtil
{
...
// Render BAAL addresses in monospace font
...
// Parse "baalcoin:" URI into recipient object, return true on successful parsing
