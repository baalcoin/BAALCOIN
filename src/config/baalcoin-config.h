/* src/config/baalcoin-config.h.  Generated from baalcoin-config.h.in by configure.  */
/* src/config/baalcoin-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef BAAL_CONFIG_H

#define BAAL_CONFIG_H
...
#define PACKAGE_NAME "BAALCOIN Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "BAALCOIN Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "baalcoin"
