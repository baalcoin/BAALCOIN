...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("BAALCOIN Core BAALCOIN-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  BAALCOIN-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoin green transaction") + "\n" +
                               "  BAALCOIN-tx [options] -create [commands]   " + _("Create hex-encoded bitcoin green transaction") + "\n" +
                               "\n";
