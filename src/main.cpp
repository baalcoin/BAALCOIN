...
#if defined(NDEBUG)
#error "BAALCOIN cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in uBAAL) are considered zero fee (for relaying and mining)
...
int64_t GetBlockValue(int nHeight)
{
	...
	if (nHeight == 0)
		...
		nSubsidy = 0.5 * COIN;
	else if (nHeight > 21601 && nHeight <= 43200)
		nSubsidy = 1 * COIN;
	else if (nHeight > 43201 && nHeight <= 64800)
		nSubsidy = 1.5 * COIN;
	else if (nHeight > 64801 && nHeight <= 86400)
		nSubsidy = 2 * COIN;
	else if (nHeight > 86401 && nHeight <= 106560)
		nSubsidy = 2.5 * COIN;
	else if (nHeight > 106561 && nHeight <= 129600)
		nSubsidy = 3 * COIN;
	else if (nHeight > 129601 && nHeight <= 151200)
		nSubsidy = 3.5 * COIN;
	else if (nHeight > 151201 && nHeight <= 172800)
		nSubsidy = 4 * COIN;
	else if (nHeight > 172801 && nHeight <= 194400)
		nSubsidy = 4.5 * COIN;
	else if (nHeight > 194401 && nHeight <= 216000)
		nSubsidy = 5 * COIN;
	else if (nHeight > 216001 && nHeight <= 237600)
		nSubsidy = 5.5 * COIN;
	else if (nHeight > 237601 && nHeight <= 259200)
		nSubsidy = 6 * COIN;
	else if (nHeight > 259201 && nHeight <= 280800)
		nSubsidy = 6.5 * COIN;
	else if (nHeight > 280801 && nHeight <= 302400)
		nSubsidy = 7 * COIN;
	else if (nHeight > 302401 && nHeight <= 324000)
		nSubsidy = 7.5 * COIN;
	else if (nHeight > 324001 && nHeight <= 345600)
		nSubsidy = 8 * COIN;
	else if (nHeight > 345601 && nHeight <= 367200)
		nSubsidy = 8.5 * COIN;
	else if (nHeight > 367201 && nHeight <= 388800)
		nSubsidy = 9 * COIN;
	else if (nHeight > 388801 && nHeight <= 525600)
		nSubsidy = 5 * COIN;
	else
		nSubsidy = 1 * COIN;
...
{
    RenameThread("BAALCOIN-scriptch");
...
bool static ProcessMessage(CNode* pfrom, string strCommand, CDataStream& vRecv, int64_t nTimeReceived)
{
    ...
    if (strCommand == "version") {
        ...
        // BAAL: We use certain sporks during IBD, so check to see if they are
